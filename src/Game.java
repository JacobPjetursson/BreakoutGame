...
public class Game extends Canvas implements Runnable {
	...
	public static STATE gameState = Game.STATE.Menu;
	...
	private void tick() {
		...
		else if (gameState == Game.STATE.Menu || gameState == Game.STATE.End || gameState == Game.STATE.Settings || gameState == Game.STATE.Help || gameState == Game.STATE.Nextlevel || gameState == Game.STATE.Store) {
			menu.tick();
			handler.tick();
		}
	}
	...
	private void render(){
		...
		if (gameState == Game.STATE.Game) {
			hud.render(g);
		} else if (gameState == Game.STATE.Menu || gameState == Game.STATE.Settings || gameState == Game.STATE.End || gameState == Game.STATE.Help || gameState == Game.STATE.Nextlevel || gameState == Game.STATE.Store) {
			menu.render(g);
		}
